 ...
 * @author Daniel
 */
public class MantReservas extends javax.swing.JFrame {

    /**
     * Creates new form MantReservas
     */
    public MantReservas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Mantenimiento de reservaciones.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MantReservas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MantReservas().setVisible(true);
            }
        });
    }
